...
При слиянии двух веток программа Git показывает различные куски и предлагет выбрать одно из нескольких действий:

* выбрать текущую версию

* выбрать новую версию

* выбрать и текущие и добавленные изменения
